                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" id="paymentForm">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" id="email" value="<?php echo e(Auth::guard('admin')->user()->email); ?>" readonly />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="name" value="<?php echo e(Auth::guard('admin')->user()->name); ?>" readonly/>
                                </div>
                            ...
                            <script src="<?php echo e(url('https://js.paystack.co/v1/inline.js')); ?>"></script>
                            <script src="<?php echo e(url('https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js')); ?>"></script>
                            <script>
                                ...
                                function payWithPaystack(e) {
                                    ...
                                    let handler = PaystackPop.setup({
                                        key: 'pk_test_2d1c5d205cc2b6187c5fd9b59c7403d4775b721b', // Replace with your public key
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response){
                                                    ...
                                                    if(response.status == true){
                                                        $('form').prepend(`
                                                            <h4 style="background-color:green; color:white">${response.message}</h4>
                                                        `);
