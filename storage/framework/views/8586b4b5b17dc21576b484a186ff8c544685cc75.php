            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="<?php echo e(url('admin/login')); ?>" method="post"><?php echo csrf_field(); ?>
                ...
                <div class="text-center">
                  ...
                  <div><a href="<?php echo e(url('admin/register')); ?>"><b><i><small class="text-danger">Register</small></i></b></a></div>
                </div>
              </form>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\canadian_wealth_app\resources\views/admin/login.blade.php ENDPATH**/ ?>