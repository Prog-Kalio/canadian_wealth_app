                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" id="paymentForm">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" id="email" value="{{ Auth::guard('admin')->user()->email }}" readonly />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="name" value="{{ Auth::guard('admin')->user()->name }}" readonly/>
                                </div>
